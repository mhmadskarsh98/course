...
<body>
  <nav class="site-navbar navbar navbar-default navbar-fixed-top navbar-mega navbar-expand-md"
    ...
    <div class="navbar-header">
      ...
      <div class="navbar-brand navbar-brand-center">
        {{-- <img class="navbar-brand-logo"  title="MSM"> --}}
        <span class="navbar-brand-text hidden-xs-down"> MSM</span>
      </div>
        ...
        <ul class="nav navbar-toolbar navbar-right navbar-toolbar-right">
          <li class="nav-item dropdown">
            <a class="nav-link navbar-avatar" data-toggle="dropdown" href="#" aria-expanded="false"
              ...
              <span>{{ Auth::user()->first_name}}&nbsp; {{ Auth::user()->last_name}} &nbsp;<i class="fa fa-caret-down"></i></span>
  ...
  <footer class="site-footer">
    <div class="site-footer-legal">© {{ date('Y') }} <a href="javascript:void(0)">MSM</a></div>
  </footer>
  <!-- Core  -->
